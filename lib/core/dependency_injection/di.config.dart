...
import '../../mvvm/data/remote/plan/plan_api.dart' as _i16;
import '../../mvvm/repo/auth_repositories.dart' as _i3;
import '../../mvvm/repo/plan_repositories.dart' as _i18;
import '../../mvvm/repo/repo_impl/auth_repositories_impl.dart' as _i4;
import '../../mvvm/repo/repo_impl/plan_repositories_impl.dart' as _i19;
import '../../mvvm/ui/auth/view_model/sign_in/sign_in_view_model.dart' as _i21;
import '../../mvvm/ui/auth/view_model/sign_up/sign_up_view_model.dart' as _i22;
...
import '../../mvvm/ui/notification/view_model/notification_view_model.dart'
    as _i13;
import '../../mvvm/ui/onboarding/view_model/onboarding_view_model.dart' as _i14;
import '../../mvvm/ui/overview/view_model/overview_view_model.dart' as _i15;
import '../../mvvm/ui/plan_overview/view_model/plan_overview_view_model.dart'
    as _i17;
import '../../mvvm/ui/splash/view_model/splash_view_model.dart' as _i23;
...
_i1.GetIt init(
  ...
  gh.factory<_i14.OnboardingViewModel>(() => _i14.OnboardingViewModel());
  gh.factory<_i15.OverviewViewModel>(() => _i15.OverviewViewModel());
  gh.factory<_i16.PlanApi>(() => _i16.PlanApi(gh<_i9.Dio>()));
  gh.factory<_i17.PlanOverViewViewModel>(() => _i17.PlanOverViewViewModel());
  gh.factory<_i18.PlanRepositories>(
      () => _i19.PlanRepositoriesImpl(gh<_i16.PlanApi>()));
  gh.factory<_i20.SettingUseCase>(() => _i20.SettingUseCase());
  ...
  gh.factory<_i26.SettingBloc>(
      () => _i26.SettingBloc(gh<_i20.SettingUseCase>()));
  return getIt;
}
